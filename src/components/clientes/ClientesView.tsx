import { Building2, Mail, MapPin, Phone, Users, UserX } from 'lucide-react';
    ...
    <div className="space-y-6 pb-8">
      ...
      {clientes.length === 0 ? (
        <div className="bg-slate-900/60 border border-slate-800 rounded-2xl p-12 text-center space-y-3">
          ...
          <h3 className="text-sm font-bold text-slate-300">Nenhum Cliente Registrado</h3>
          <p className="text-xs text-slate-500 max-w-md mx-auto">
            A carteira de clientes será sincronizada automaticamente a partir das novas Ordens de Produção e Pedidos importados.
          </p>
        </div>
      ) : (
